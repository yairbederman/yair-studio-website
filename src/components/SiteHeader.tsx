 ...
 *  defaults to EN so existing usage is unchanged. Stays a Server Component; the
 *  active-state nav links, language toggle, and the auto-hide wrapper (which
 *  renders the <header> and hides it on mobile scroll-down) are isolated client
