...
const HE_CARDS: Record<string, CardStrings> = {
  ...
  "ai-ops-pilot": {
    ...
    summary:
      "אם התהליך בשל לפיילוט, מגדירים עוזר AI תפעולי פרטי סביב תהליך ממוקד: דוח בוקר, follow-up, סיכום פגישות או מסמכים למשימות.",
  },
  "follow-up-machine": {
  ...
  "office-command-center": {
    ...
    cta: "בקרוב",
    summary:
      "תמונת מצב יומית של מסמכים, מיילים, יומן, משימות, אישורים ודברים שמחכים לבעל העסק.",
  },
};
