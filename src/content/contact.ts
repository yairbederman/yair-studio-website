...
const he: ContactContent = {
  ...
  send: {
    title: "מה לשלוח",
    intro:
      "ספרו בקצרה איפה העבודה נתקעת: מיילים, משימות, לקוחות, מסמכים, פגישות או follow-up.",
    items: [
      {
        title: "התהליך",
  ...
  goodFirst: {
    ...
    intro: "תהליכים שקל למפות ומתאימים להתחלה מהירה.",
    items: [
  ...
  cta: {
    ...
    body: "תארו תהליך אחד שמעצבן אתכם ואיפה הוא נתקע. אתם כותבים ישירות לאדם שממפה ובונה את המערכת.",
    ctaLabel: "שליחת מייל",
    ctaHref: CONTACT_MAILTO,
