...
const he: ContactContent = {
  hero: {
    title: "למפות תהליך אחד",
    lead: "בוחרים תהליך אחד שמאט את העסק, וממפים איך הוא באמת רץ, לפני שמחליטים אם לבנות בכלל. כמה שורות במייל או בוואטסאפ מספיקות להתחלה. עברית או אנגלית, מה שנוח.",
    emailCta: { label: "שליחת מייל", href: CONTACT_MAILTO },
  ...
  next: {
    ...
    steps: [
      ...
      },
      {
        ...
        desc: "מקבלים תמונה ברורה: מה הופך לאוטומטי, מה נשאר כמו שהוא, ומה עושים קודם.",
      },
    ],
  },
  send: {
    title: "מה לשלוח",
    intro: "כמה שורות מספיקות להתחלה. כמה שיותר קונקרטי, יותר טוב.",
    items: [
      {
        title: "התהליך",
      ...
      },
      {
        ...
        desc: "איפה העבודה חיה היום: מייל, מסמכים, גיליונות, צ'אט, CRM — מה שיש.",
      },
      {
        title: "איפה זה נתקע",
  ...
  goodFirst: {
    title: "תהליכים טובים להתחלה",
    intro: "תהליכים שממופים נקי ונוטים להחזיר את ההשקעה מהר.",
    items: [
      "סיכומי פגישות שהופכים למשימות ומעקב",
      "מיון מייל ויומן",
      "דשבורד של עבודה תקועה או באיחור",
      "לולאת אישורים לתוכן או לקמפיינים",
      "תהליך משרדי עתיר מסמכים",
    ],
  },
  human: {
    title: "מה נשאר אנושי",
    intro: "האוטומציה מטפלת בעבודה השחורה; שיקול הדעת נשאר אצל אנשים.",
    items: [
      {
      ...
      },
      {
        ...
        desc: "מה נבנה, ובאיזה סדר — ההחלטה שלכם. המפה מזינה אותה; אתם מחליטים.",
      },
    ],
  },
  cta: {
    heading: "הודעה קצרה היא כל הצעד הראשון.",
    body: "תארו את התהליך ואיפה הוא מאט. אתם כותבים ישירות לאדם שממפה ובונה את המערכת.",
    ctaLabel: "שליחת מייל",
    ctaHref: CONTACT_MAILTO,
